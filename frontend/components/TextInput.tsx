...
export default memo(function TextInput({
  ...
  return <div className="relative w-[30rem]">
      <input value={value} onChange={(e: any) => handleChange(e.target.value)} type="text" placeholder="Wprowadź sekwencję DNA/RNA..." className="block w-full pl-8 pr-24 py-5 rounded-full bg-gray-50" />
      {/* Arrow button. */}
